...
<head>
  ...
  <link rel="stylesheet" href=" admin-assets/css/custom-admin.css ">
...
<body class="hold-transition skin-blue sidebar-mini">
 ...
 <jsp:useBean id="userDAO" class="dao.UserDAO"></jsp:useBean>
	<c:set var="user" value="${userDAO.getUserDetail(sessionScope.email) }"></c:set>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
      ...
      <form action="createBlogAdmin" method="post" id="form-category" class=" form" novalidate enctype="multipart/form-data">
       <div class="form-group col-sm-6 col-sm-offset-3">
          <label for="title">Tên Blog</label>
           <input type="text" class="form-control" name="title" id="title" required placeholder="Nhập Tên Tour">
        </div>

        <div class="form-group col-sm-6 col-sm-offset-3">
          <label for="imageTitle"> Ảnh đại diện </label>
        ...
        <div class="form-group col-md-11 col-sm-offset-1">
          ...
          <!-- <div class="col-md-12"> -->
           <textarea id="content" class="form-control content" name="content" rows="10"></textarea>
