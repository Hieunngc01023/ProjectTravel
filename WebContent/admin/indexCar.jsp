				...
				<table class="table table-hover">
					<tbody>
						<tr>
							...
							<th>Giá/Ngày</th>
							<th>Số Lượng Xe</th>
							<th><a href="createCar.jsp" class="btn btn-success btn-xs"> <i
									class="fa fa-plus"></i> Add new
							</a></th>
						</tr>
						<jsp:useBean id="carDao" class="adminDAO.CarDAO" scope="page"></jsp:useBean>
						<c:if test="${carDao.getListCars().size() > 0 }">
							<c:forEach items="${carDao.getListCars() }" var="car">
								<tr>
									<td>${car.idCar }</td>
									<td>
										<p>${car.nameCar }</p> <img src="admin-assets/img/${car.imageTitle }"
										width=100 alt="">
									</td>
									<td>${car.brand }</td>
									<c:choose>
