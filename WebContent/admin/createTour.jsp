...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
      ...
      <form action="addTour" method="post" id="form-tour" class=" form" enctype="multipart/form-data" >
       <div class="form-group col-sm-6 col-sm-offset-3">
          <label for="title">Tên Tour</label>
           <input type="text" class="form-control" name="title" id="title" placeholder="Nhập Tên Tour">
        </div>
        <div class="form-group col-sm-6 col-sm-offset-3">
        ...
        <div class="form-group col-sm-6 col-sm-offset-3 ">
          <label for="placePickup">Địa điểm đón </label>
           <input type="text" class="form-control" name="placePickup" id="placePickup" placeholder="Nhập địa điểm đón">
        </div>
        <div class="form-group col-sm-6 col-sm-offset-3">
          <label for="placeDrop">Địa điểm đến</label>
           <input type="text" class="form-control" name="placeDrop" id="placeDrop" placeholder="Nhập địa điểm đến">
        </div>

        <div class="form-group col-sm-6 col-sm-offset-3">
          <label for="imageTitle"> Ảnh đại diện tour</label>
          <img id="target-avatar" src="" width="152" alt="">
          <!-- <img src="admin-assets/img/user2-160x160.jpg"  alt="User Image"> -->
            <input type="file" onchange="readURL(this)" name="imageTitle" id="imageTitle"  class="form-control">
  ...
  ckeditor("content");
   $( document ).ready(function() {
      $('#form-tour').submit(function(){
        ...
        var placePickup    = $.trim($('#placePickup').val());
        var placeDrop    = $.trim($('#placeDrop').val());
        ...
        var flag = true;
          // title
          if (title.length <= 0){
           $('#title').attr("placeholder", "Bạn chưa nhập tên Tour");
           flag = false;
                   // debugger;
                 }
                 else{
              ...
              if (placePickup.length <= 0){
               $('#placePickup').attr("placeholder", "Bạn chưa nhập điểm đón");
               flag = false;
                   // debugger;
                 }
                 else{
                  $('#placePickup').attr("placeholder", "");
              }
              //
               if (placeDrop.length <= 0){
               $('#placeDrop').attr("placeholder", "Bạn chưa nhập điểm tới");
               flag = false;
                   // debugger;
                 }
                 else{
                  $('#placeDrop').attr("placeholder", "");
              }
              //
                if (category.length <= 0){
               $('#categoryError').text( "Bạn chưa chọn thể loại ");
               flag = false;
                   // debugger;
                 }
                 else{
              ...
              //
               ...
               //
             /*   if (content == ""){
               $('#contentError').text( "Bạn chưa nhập lịch trình Tour");
               flag = false;
                   // debugger;
                 }
                 else{
