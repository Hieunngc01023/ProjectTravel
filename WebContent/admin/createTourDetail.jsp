	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<jsp:useBean id="tourDAO" class="adminDAO.TourDAO"></jsp:useBean>
					<c:set var="tour" value="${tourDAO.getTourbyID(param.idTour)}"></c:set>
			<form action="addNewTourDetailAction" method="post"
				id="form-tourDetail" class=" form">
				<div class="col-sm-6">
					<div class="form-group col-sm-8 col-sm-offset-2">
						<label class="idTour">Tên Tour </label> <input type="text" value="${tour.title }"
							class="form-control" readonly="" name="nameTour" id="name">
						<span class="text-danger" id="TourError"></span>
					</div>
					<div class="form-group col-sm-8 col-sm-offset-2">
						<label class="idTour">Tên Danh Mục </label> <input type="text" value="${tour.category }"
							class="form-control" readonly="" name="nameCategory" id="name">
						<span class="text-danger" id="TourError"></span>
					</div>
					<div class="form-group col-sm-8 col-sm-offset-2">
						<label for="seat">Chỗ Ngồi</label> <input type="number"
							class="form-control" name="seat" id="seat"
							placeholder="Nhập số chỗ ngồi của Tour" required>
					</div>
					<div class="form-group col-sm-8 col-sm-offset-2">
						...
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right"
								name="timeBegin" id="timeBegin" required>
						</div>
					...
					<div class="form-group col-sm-8 col-sm-offset-2">
						...
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right" name="timeEnd"
								id="timeEnd" required>
						</div>
				...
				<div class="col-sm-6">
					...
					<div class="form-group col-sm-8 col-sm-offset-1">
						<label for="realPrice">Giá đã sale</label> <input type="number"
							class="form-control" name="realPrice" id="realPrice"
							placeholder="Nhâp giá bán thật" required>
					</div>
					<div class="form-group col-sm-8 col-sm-offset-1">
						<label for="virtualPrice">Giá Hiển Thị</label> <input
							type="number" class="form-control" name="virtualPrice"
							id="virtualPrice" placeholder="Nhập giá hiển thị " required>
					</div>
					<div class="form-group col-sm-8 col-sm-offset-1">
						<label for="sale1">Giảm giá từ 6 -> 14 người </label> <input
							type="number" class="form-control" name="sale1" id="sale1"
							placeholder="Nhập giảm bao % " required>
					</div>
					<div class="form-group col-sm-8 col-sm-offset-1">
						<label for="sale2">Giảm giá từ 15 người trở lên </label> <input
							type="number" class="form-control" name="sale2" id="sale2"
							placeholder="Nhập giảm bao %" required>
					</div>
					<input type="hidden" value="${param.idTour }" name="idTour">
					<div class="form-group col-sm-8 col-sm-offset-1">
						<label for="title">Tour Giá Sốc</label>
						<div class="radio-list ">
							<label class="radio-inline"> <input type="radio"
								name="important" id="optionsRadios4" value="1"> Có
							</label> <label class="radio-inline"> <input type="radio"
								name="important" id="optionsRadios5" checked="" value="0">
								Không
							</label>
						</div>
					</div>
				...
				<div class="form-group col-sm-7  col-sm-offset-5">
					...
					<a href="index.jsp" class="btn btn-md btn-danger"> <i
